$(function () {
    ...
    if (typeof $.toast === 'function') {
        $.toast({
            heading: 'Welcome to Madobi Jewelers'
    ...
    if ($('#morris-area-chart').length && typeof Morris !== 'undefined') {
        Morris.Area({
    ...
    if ($('#morris-area-chart2').length && typeof Morris !== 'undefined') {
        Morris.Area({
