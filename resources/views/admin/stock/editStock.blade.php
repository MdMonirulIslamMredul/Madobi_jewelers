    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form2" class="form-horizontal" action="{{ route('stock.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">                         
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @enderror">
                                        ...
                                        @forelse ($categories as $category)
                                            <option @if ($category->id == $stock->category_id)
                                                selected
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="product_id" name="product_id"
                                        ...
                                        <option selected value="{{$stock->product_id}}">{{$stock->product->product_name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" name="karat" value="{{ $stock->karat }}" id="karat">
                                    @error('karat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" id="unit_price" name="unit_price" value="{{ $stock->unit_price }}" id="unit_price">
                                    @error('unit_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" min="1" id="qtr" name="qtr" value="{{ $stock->qty }}" id="qtr">
                                    @error('qtr')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" min="1" id="gram" readonly name="gram" value="{{ $stock->gram }}">
                                    @error('gram')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5"  name="bhori" value="{{ $stock->bhori }}" id="vori">
                                    @error('bhori')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" id="ana" name="ana" value="{{ $stock->ana }}">
                                    @error('ana')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" id="roti" name="roti" value="{{ $stock->roti }}">
                                    @error('roti')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" id="point" name="point" value="{{ $stock->point }}">
                                    @error('roti')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <fieldset>
                                        <div>
                                            <div class="row text-center">
                                                <div class="col-6">
                                                    <input type="radio" id="is_shop" name="location" value="is_shop" @if($stock->location=='is_shop')
                                                    checked 
                                                    @endif />
                                                    <label class="form-control" for="is_shop">দোকান</label>
                                                </div>
                                                <div class="col-6">
                                                    <input type="radio" id="is_warehouse" name="location" value="is_warehouse" @if($stock->location=='is_warehouse')
                                                    checked 
                                                 @endif />
