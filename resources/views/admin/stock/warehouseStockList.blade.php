    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h3><i class="fa-solid fa-warehouse me-2 text-success"></i>গুদাম স্টক তালিকা</h3>
                <span class="badge bg-success fs-6">মোট পণ্য: {{ $purchases->count() }}</span>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="mb-4">
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <span class="fw-bold text-secondary" style="font-size:13px;">ক্যারেট অনুযায়ী স্টক সারসংক্ষেপ</span>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-2">
                        <div class="p-3 rounded-3 shadow-sm h-100 position-relative overflow-hidden"
                             style="background:{{ $clr['bg'] }};color:#fff;">
                            <div style="position:absolute;top:-14px;right:-14px;width:70px;height:70px;border-radius:50%;background:rgba(255,255,255,.12);"></div>
                            <div class="fw-bold mb-2" style="font-size:20px;letter-spacing:1px;">{{ $label }}</div>
                            <div class="d-flex flex-column gap-1" style="font-size:12px;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span style="opacity:.85;"><i class="fa-solid fa-box fa-xs me-1"></i>মোট পণ্য</span>
                                    <span class="badge rounded-pill" style="background:rgba(255,255,255,.3);font-size:11px;">{{ $row['count'] }} টি</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mt-1">
                                    <span style="opacity:.85;"><i class="fa-solid fa-weight-hanging fa-xs me-1"></i>গ্রস ওজন</span>
                                    <span class="fw-semibold">{{ $row['gross'] }} গ্রাম</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span style="opacity:.85;"><i class="fa-solid fa-atom fa-xs me-1"></i>বিশুদ্ধতা</span>
                                    <span class="fw-semibold">{{ $row['purity'] }} গ্রাম</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-2">
                        <div class="p-3 rounded-3 shadow-sm h-100 position-relative overflow-hidden"
                            ...
                            <div class="fw-bold mb-2 d-flex align-items-center gap-1" style="font-size:15px;">
                                <i class="fa-solid fa-sigma fa-sm"></i> মোট সর্বমোট
                            </div>
                            <div class="d-flex flex-column gap-1" style="font-size:12px;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span style="opacity:.75;"><i class="fa-solid fa-box fa-xs me-1"></i>মোট পণ্য</span>
                                    <span class="badge rounded-pill bg-light text-dark" style="font-size:11px;">{{ $totalCount }} টি</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mt-1">
            ...
            <table id="config-table" class="table display table-striped border no-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- ক্যাটাগরি ও পণ্যের নাম (clickable → product detail modal) --}}
                        <td class="text-center">
                            <button type="button"
