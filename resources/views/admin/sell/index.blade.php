        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form2" class="form-horizontal" action="{{ route('sells.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $transaction->productCategory->category_name }}</td>
                            <td class="text-center">{{ $transaction->product->product_name }}</td>

                            <td class="text-center">
                                @foreach ($transaction->sells as $sell)
                                <span class="badge bg-info"> {{ $sell->bhori ?? 0}} ভরি, {{ $sell->ana ?? 0}} আনা, {{ $sell->roti ?? 0}} রতি,  {{ $sell->point ?? 0}} পয়েন্ট</span> <span class="badge bg-danger">({{$sell->gram ?? 0}} গ্রাম )</span><br>
                                @endforeach
                            </td>
                            ...
                            <td class="text-center">
                                <div class="action-btns d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="{{ route('sells.edit', $transaction->id) }}"
