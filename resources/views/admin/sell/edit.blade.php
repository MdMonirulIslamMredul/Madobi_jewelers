        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('sells.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                                    ...
                                    <select id="category_id" name="category_id"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" 
                                                {{ $transaction->productCategory->id == $category->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('qtr') is-invalid @enderror" rows="5" min="1" id="qtr" name="qtr" value="{{ old('qtr', count($transaction->sells)) }}">
                                    @error('qtr')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div id="inputContainer">
                                @foreach ($transaction->sells as $index => $sell)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control vori-input" rows="5" name="bhori[]" value="{{ old('bhori.' . $index, $sell->bhori) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="ana" class="form-label mb-2">আনা</label>
                                                    <input type="number" class="form-control ana-input" rows="5" name="ana[]" value="{{ old('ana.' . $index, $sell->ana) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="roti" class="form-label mb-2">রতি</label>
                                                    <input type="number" class="form-control roti-input" rows="5" name="roti[]" value="{{ old('roti.' . $index, $sell->roti) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="point" class="form-label mb-2">পয়েন্ট</label>
                                                    <input type="number" class="form-control point-input" rows="5" name="point[]" value="{{ old('point.' . $index, $sell->point) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="karat" class="form-label mb-2">ক্যারাট</label>
                                                    <input type="number" class="form-control" rows="5" name="karat[]" value="{{ old('karat.' . $index, $sell->karat) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="unit_price" class="form-label mb-2">একক মূল্য/ভরি</label>
                                                    <input type="number" class="form-control unit_price_input" rows="5" name="unit_price[]" value="{{ old('unit_price.' . $index, $sell->unit_price) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="wage" class="form-label mb-2">মজুরি</label>
                                                    <input type="number" class="form-control wage-input @error('wage')
                                                    is-invalid
                                                @enderror" rows="5" id="wage" name="wage[]" value="{{ old('wage'. $index, $sell->wage) }}">
                                                    @error('roti')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" id="gram" class="form-control" rows="5" min="1" name="gram[]" readonly value="{{ old('gram.' . $index, $sell->gram) }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="price" class="form-label mb-2">মূল্য</label>
                                                    <input type="number" class="form-control price-input" readonly rows="5" name="price[]" value="{{ old('total_price.' . $index, $sell->total_price) }}" id="price">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                    @enderror" rows="5" name="order_date" value="{{ old('order_date',$transaction->sells[0]->order_date) }}" id="order_date">
                                    @error('order_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                    @enderror" rows="5" name="receive_date" value="{{ old('receive_date',$transaction->sells[0]->receive_date) }}" id="receive_date">
                                    @error('receive_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    ...
                                    is-invalid
                                @enderror" rows="5" name="due_payment_date" value="{{ old('due_payment_date',$transaction->sells[0]->due_payment_date) }}" id="due_payment_date">
                            ...
                            <div class="mb-3 col-md-3 text-center">
                                <label for="photo" class="form-label">{{ __('ডিডের ছবি') }}</label>    
                                <div class="d-block position-relative">
                                    <img id="previewIm" src="{{ asset('user/sells/'. $transaction->sells[0]->deed_photo ) }}" alt="your image" width="350" height="180" onclick="document.getElementById('photoI').click();" style="cursor: pointer;">
...
<script>
    $(document).ready(function() {
        ...
        function addInputEventListeners() {
            ...
            var wageInputs = container.querySelectorAll('.wage-input');
        ...
        function CalculateTotal() {
            ...
            var roti = card.querySelector('.roti-input').value || 0;
            var point = card.querySelector('.point-input').value || 0;
            var wage = card.querySelector('.wage-input').value || 0;
