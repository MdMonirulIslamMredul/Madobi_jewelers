            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="basic-icon-default-phone2">Phone 2</label>
                            <div class="input-group">
                                <input type="text" name="phone2" id="user_phone2"
                                    class="form-control
                        @error('phone2')
                            is-invalid
                        @enderror"
                                    value="{{ old('phone2') }}" placeholder="Enter Alternative Phone Number">
                                @error('phone2')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
