...
<script src="{{ asset('admin/assets/node_modules/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js') }}"></script>
<script src="{{ asset('admin/assets/node_modules/dff/dff.js') }}"></script>
<script src="{{ asset('admin/assets/node_modules/multiselect/js/jquery.multi-select.js') }}"></script>
<script>
    $(function () {
