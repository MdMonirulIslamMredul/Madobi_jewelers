    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2 text-start" style="margin-top: 34px;">
                        <a href="{{ route('purchases.report.index', ['pdf' => 1] + request()->query()) }}" class="btn btn-outline-success btn-lg">প্রিন্ট করুন</a>
                    </div>
                    @endif
                    <div class="col-10">
                        <form action="{{ route('purchases.report.index') }}" method="GET">
                            <div class="row">
                                <div class="col-md-6">
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $cat }}</td>
                            <td>{{ $product }}</td>
                            <td>{{ $purchase->bhori ?? 0 }} ভরি, {{ $purchase->ana ?? 0 }} আনা, {{ $purchase->roti ?? 0 }} রতি, {{ $purchase->point ?? 0 }} পয়েন্ট </td>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-3">
                        <span class="badge bg-primary"><h6 class="mt-2">সর্বমোট ক্রয়: {{ $totalBhori}} ভরি, {{$totalAna}} আনা, {{$totalRoti}} রতি , {{$totalPoint}} পয়েন্ট</h6></span>
                    </div>
                    <div class="col-md-3">
