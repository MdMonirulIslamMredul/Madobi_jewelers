        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form2" class="form-horizontal" action="<?php echo e(route('sells.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control wage-input <?php $__errorArgs = ['wage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3 text-center">
                                <label for="photo" class="form-label"><?php echo e(__('ডিডের ছবি')); ?></label>    
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">কাস্টমার</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <span class="badge bg-info"> <?php echo e($sell->bhori ?? 0); ?> ভরি, <?php echo e($sell->ana ?? 0); ?> আনা, <?php echo e($sell->roti ?? 0); ?> রতি,  <?php echo e($sell->point ?? 0); ?> পয়েন্ট</span> <span class="badge bg-danger">(<?php echo e($sell->gram ?? 0); ?> গ্রাম )</span><br>
                            ...
                            <td class="text-center">
                                <div class="action-btns d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('sells.edit', $transaction->id)); ?>"
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhobijewellers/public_html/resources/views/admin/sell/index.blade.php ENDPATH**/ ?>