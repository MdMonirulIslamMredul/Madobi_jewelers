    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form2" class="form-horizontal" action="<?php echo e(route('stock.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">                         
                            <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>" rows="5" id="unit_price" name="unit_price" value="<?php echo e(old('unit_price')); ?>" id="unit_price">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhobijewellers/public_html/resources/views/admin/stock/createStock.blade.php ENDPATH**/ ?>