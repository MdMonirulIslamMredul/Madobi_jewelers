        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2 text-start" style="margin-top: 34px;">
                        <a href="<?php echo e(route('bondhok.report.index', ['pdf' => 1] + request()->query())); ?>" class="btn btn-outline-danger btn-lg">প্রিন্ট করুন</a>
                    </div>
                    <?php endif; ?> 
                    <div class="col-md-10">
                        <form action="<?php echo e(route('bondhok.report.index')); ?>" method="GET">
                            <div class="row">
                                <div class="col-md-6">
            ...
            <div class="card-body">
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <tbody>
                        <?php $sl = 1; ?>
                        <?php $__empty_1 = true; $__currentLoopData = $bondhoks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bondhok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                         <tr>
                            <td><strong><?php echo e($sl); ?></strong></td>
                            <td><?php echo e($bondhok->start_time); ?></td>
                            <td><?php echo e($bondhok->user->name); ?> (<?php echo e($bondhok->user->phone); ?>)</td>
                            <td><?php echo e($bondhok->product->name); ?></td>
                            <td><?php echo e($bondhok->bhori ?? 0); ?> ভরি, <?php echo e($bondhok->ana ?? 0); ?> আনা, <?php echo e($bondhok->roti ?? 0); ?> রতি</td>
                            <td><?php echo e($bondhok->base_amount); ?></td>
                            <td><?php echo e($bondhok->interest_rate); ?>%</td>
                            <td><?php echo e($bondhok->payable_amount); ?></td>
                            <td><?php echo e($bondhok->paid); ?></td>
                            <td><?php echo e($bondhok->due); ?></td>
                        </tr>
                        <?php $sl++ ?>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-3">
                        <span class="badge bg-primary"><h6 class="mt-2">সর্বমোট বন্ধক: <?php echo e($totalBhori); ?> ভরি, <?php echo e($totalAna); ?> আনা, <?php echo e($totalRoti); ?> রতি, <?php echo e($totalPoint); ?> পয়েন্ট</h6></span>
                    </div>
                    <div class="col-md-3">
                        <span class="badge bg-success"><h6 class="mt-2">সর্বমোট টাকা: <?php echo e($totalPrice); ?> /-</h6></span>
                    </div>
                    <div class="col-md-3">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhobijewellers/public_html/resources/views/admin/report/bondhok/index.blade.php ENDPATH**/ ?>