    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('bondhok.product.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" rows="5" name="name" value="<?php echo e(old('name')); ?>" id="name">
        ...
        <div class="card">
            <div class="card-header">
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <tbody>
                        <?php $sl = 1; ?>
                        <?php $__empty_1 = true; $__currentLoopData = $b_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                            ...
                            <td class="text-center">
                                <div class="action-btns d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('bondhok.product.edit', $category->id)); ?>"
                                    ...
                                    <div>
                                        <form action="<?php echo e(route('bondhok.product.delete')); ?>"
                                            method="POST">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="p_id" value="<?php echo e($category->id); ?>">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Madobi_jewelers\resources\views/admin/bondhok/b_product/index.blade.php ENDPATH**/ ?>