...
unset($__errorArgs, $__bag); ?>" rows="5" name="product_name" value="<?php echo e(old('product_name')); ?>" id="product_name">
            ...
            <div class="card-header">
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <strong><?php echo e($products->firstItem() + $loop->index); ?></strong>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="action-btns d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('product.edit', $product->product_slug)); ?>"
                                    ...
                                    <div>
                                        <form action="<?php echo e(route('product.destroy', $product->product_slug)); ?>"
                                            method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhobijewellers/public_html/resources/views/admin/product/product.blade.php ENDPATH**/ ?>