    ...
    // For Create
        ...
        const getProducts = (category_id, selected = null) => {
            axios.get(`${window.location.origin}/get-products/${category_id}`).then(res => {
                ...
                element.empty()
                element.append(`<option>Select a Product</option>`)
...
<script>
    ...
    $(document).ready(function() {
        $('#unit_price, #bhori, #ana, #roti').on('input', function() {
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhobijewellers/public_html/resources/views/admin/purchase/warehouse.blade.php ENDPATH**/ ?>