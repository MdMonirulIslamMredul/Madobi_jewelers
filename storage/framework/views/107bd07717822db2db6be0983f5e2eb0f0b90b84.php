        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form2" class="form-horizontal" action="<?php echo e(route('admin.bondhok.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="form-group mb-3 col-12 custom">
                                ...
                                <select class="form-control select2 old" name="user_id" id="user_id">
                                    ...
                                    <option value="<?php echo e($c->id); ?>" data-image="<?php echo e(asset('user/' . $c->image)); ?>">
                                        <?php echo e($c->name); ?> - <?php echo e($c->phone); ?> (<?php echo e($c->role->role_name); ?>)
...
unset($__errorArgs, $__bag); ?>" rows="5" min="1" id="qtr" name="qtr" value="<?php echo e(old('qtr')); ?>">
                                    <?php $__errorArgs = ['qtr'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-3 text-center">
                                <label for="photo" class="form-label"><?php echo e(__('বন্ধক সম্পর্কিত ছবি')); ?></label>    
                                <div class="d-block position-relative">
                                    <img id="previewIm" src="<?php echo e(asset('cover/default-cover.jpg' )); ?>" alt="your image" width="200" height="120" onclick="document.getElementById('photoI').click();" style="cursor: pointer;">
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($transaction->bondhok_product->name ?? 'N/A'); ?></td>
                            <td class="text-center">
                                <?php $__currentLoopData = $transaction->bondhoks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bondhok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="badge bg-info"><?php echo e($bondhok->bhori ?? 0); ?> ভরি, <?php echo e($bondhok->ana ?? 0); ?> আনা, <?php echo e($bondhok->roti ?? 0); ?> রতি,  <?php echo e($bondhok->point ?? 0); ?> পয়েন্ট</span> <span class="badge bg-danger">(<?php echo e($bondhok->gram ?? 0); ?> গ্রাম )</span><br>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </td>
                            <td class="text-center"><?php echo e($transaction->total_price ?? 'N/A'); ?></td>
                            <td class="text-center">
                                <form class="form-horizontal" action="<?php echo e(route('bondhok.paid.update')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="transaction_id" value="<?php echo e($transaction->id); ?>">
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="paid" value="<?php echo e($transaction->total_payment ?? 0); ?>">
                            ...
                            <td class="text-center"> <span class="badge bg-danger"><h6><?php echo e($transaction->due_payment ?? 'N/A'); ?></h6></span></td>
                            <td class="text-center"><?php echo e($transaction->due_payment_date ?? 'N/A'); ?></td>
                            ...
                            <td class="text-center">
                                <div class="action-btns d-flex align-items-center">
                                    ...
                                    <div>
                                        <form action="<?php echo e(route('bondhok.delete')); ?>"
                                            method="POST">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="transaction_id" value="<?php echo e($transaction->id); ?>">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhobijewellers/public_html/resources/views/admin/bondhok/bondhok.blade.php ENDPATH**/ ?>