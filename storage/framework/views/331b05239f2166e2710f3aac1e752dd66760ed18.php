    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="form2" class="form-horizontal" action="<?php echo e(route('purchase.store')); ?>" method="POST" enctype="multipart/form-data" data-calculate-total-url="<?php echo e(route('calculate.total')); ?>" data-convert-url="<?php echo e(route('convert.to.gram')); ?>" data-calculate-url="<?php echo e(route('calculate')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" rows="5" id="total_price" name="total_price" value="<?php echo e(old('total_price')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="5" id="adv_payment" name="adv_payment" value="<?php echo e(old('adv_payment')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="5" id="due_payment" name="due_payment" value="<?php echo e(old('due_payment')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="5" id="total_payment" name="total_payment" value="<?php echo e(old('total_payment')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col-md-4 text-center">
                            ...
                            <div class="d-block position-relative">
                                <img id="previewIm" src="<?php echo e(asset('cover/default-cover.jpg' )); ?>" alt="your image" width="350" height="180" onclick="document.getElementById('photoI').click();" style="cursor: pointer;">
            ...
            <table id="config-table" class="table display table-striped border no-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php $__empty_2 = true; $__currentLoopData = $transaction->purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <span class="badge bg-primary"><?php echo e($purchase->productCategory->category_name ?? 0); ?> </span><br>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                            <?php endif; ?>
                        </td>
                        <td class="text-center">
                            <?php $__empty_2 = true; $__currentLoopData = $transaction->purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <span class="badge bg-info"><?php echo e($purchase->product->product_name ?? 0); ?></span> <br>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                            <?php endif; ?>
                        </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Madobi_jewelers\resources\views/admin/purchase/purchase.blade.php ENDPATH**/ ?>