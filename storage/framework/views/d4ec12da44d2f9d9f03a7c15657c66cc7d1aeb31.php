<?php if(Session::has('alert.config') || Session::has('alert.delete')): ?>
    ...
    <?php if(config('sweetalert.alwaysLoadJS') === false && config('sweetalert.neverLoadJS') === false): ?>
        <script src="<?php echo e($cdn ?? asset('vendor/sweetalert/sweetalert2.all.js')); ?>"></script>
    <?php endif; ?>
    <script>
...
<?php endif; ?>
<?php /**PATH /home/madhobijewellers/public_html/resources/views/vendor/sweetalert/alert.blade.php ENDPATH**/ ?>